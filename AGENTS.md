...
- **tokenkey-fingerprint-alignment-all** — Run the combined TokenKey fingerprint refresh for Claude Code, Kiro, Antigravity, and Codex. Use when multiple client fingerprints need one…

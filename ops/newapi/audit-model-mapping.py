...
New mapping floors converge through a reviewed bundle and
``ops/pricing/modelops.py activate``. Emergency removal only is available through
``ops/newapi/apply-model-mapping-live.py remove-live``.
"""

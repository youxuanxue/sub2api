...
INSERT INTO accounts(id,name,platform,type,status,schedulable,concurrency,priority,channel_type,
  ...
  VALUES
    (42,'weird''name','anthropic','oauth','active',true,10,50,0,1.0,true,'{"stability_tier":"l5"}'),
    (11,'migration-source-11','anthropic','oauth','active',true,10,50,0,1.0,true,'{}'),
    (12,'migration-source-12','anthropic','oauth','active',true,10,50,0,1.0,true,'{}');
"""

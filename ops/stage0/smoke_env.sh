...
#   prod secrets: TK_SMOKE_PROD_ANTHROPIC_KEY, TK_SMOKE_PROD_GEMINI_KEY, TK_SMOKE_PROD_OPENAI_OAUTH_KEY
#   prod vars:    TK_SMOKE_PROD_ANTHROPIC_MODEL, TK_SMOKE_PROD_GEMINI_MODEL, TK_SMOKE_PROD_OPENAI_OAUTH_MODEL

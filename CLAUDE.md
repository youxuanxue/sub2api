...
Model serving SSOT (prod `model_mapping` + catalog/pricing alignment; edge keeps empty mapping): [`docs/global/agent-reference.md`](docs/global/agent-reference.md#model-serving-ssot-model_mapping-catalog-prod-vs-edge).

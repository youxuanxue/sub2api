...
invariants. This replaced the former manual debt reminder with an executable gate.

No report file is written; CI/preflight output is the source of truth.
...
US-008/US-009/US-010 e2e tests tracked by Draft story status)

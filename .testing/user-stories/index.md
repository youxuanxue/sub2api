...
| US-027 | 公开模型 + 价格目录页（未登录可访） | InTest | `.testing/user-stories/stories/US-027-public-pricing-catalog.md` |
| US-028 | 注册赠额（默认 $1.00 USD，admin 可配；3 条注册路径全覆盖） | Draft | `.testing/user-stories/stories/US-028-signup-bonus-balance.md` |
| US-029 | 注册成功自动签发 trial API Key + Dashboard Quick Start 卡片 | Draft | `.testing/user-stories/stories/US-029-auto-first-api-key.md` |

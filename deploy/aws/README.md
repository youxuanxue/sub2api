...
```bash
# 仅导出
QA_DUMP_S3_BUCKET=<staging-bucket> bash scripts/fetch-prod-qa-dump.sh
...
```bash
bash scripts/fetch-prod-error-clusters.sh                   # 默认 24h，输出 error clustering artifact 到 ./.error-clusters/

...
const en: LocaleOverlay = {
  ...
  "studio": {
    ...
    "chat": {
      ...
      "avatarUser": "Me",
      "avatarAssistant": "AI",
      "limitsHint": "Up to {turns} turns in memory; max output tokens capped at {maxTok}; {timeoutSec}s timeout per chat request.",
      "truncatedHint": "The reply was cut off because it reached the Max tokens limit. Increase Max tokens (up to {maxTok}) and send again for a longer answer.",
      "timedOut": "The chat request timed out after {timeoutSec}s. Try again with a lower Max tokens value or a shorter prompt.",
      ...
      "integrationsHint": "Open a client with prepared connection settings. Web clients keep the key out of the URL.",
      "integrationsAppHint": "Requires the client app installed (opens a custom URL scheme).",
      "integrationsManualKeyHint": "Opens provider settings with the gateway address only. Paste the key in the client.",
      "integrationsManualKeyShort": "paste key",
  ...
  "keys": {
    ...
    "qaBundle": {
      ...
      "export": "Export ZIP",
      "exportContents": "Includes conversations, tool links and captured request evidence.",
      "exporting": "Preparing…",
  ...
  "quickstart": {
    ...
    "categories": {
      ...
      "apps": "AI apps",
      "build": "Build and integrate"
    },
    "supportVerified": "Recommended",
    "supportVerifiedDetail": "Continuously verified against live gateway probes",
    "supportImport": "One tap",
    "supportImportDetail": "Opens the client and imports settings for you",
    "supportCompatible": "Manual setup",
    "supportCompatibleDetail": "Standard protocol — paste the key in the client",
    "legendToggle": "What do the badges mean?",
    "connectionWaiting": "Waiting for first request",
    "connectionWaitingHint": "Send a test request to confirm this key and model work.",
    "probeAuthMs": "Auth {ms}ms",
    "probeModelMs": "Model {ms}ms",
    "probeTotalMs": "{ms}ms total",
    "connectionConnected": "Connected",
    "connectionTesting": "Testing connection…",
    "connectionFailed": "Connection failed",
    "connectionBlocked": "Finish setup before testing",
    "sendTest": "Send test request",
    "retryTest": "Retry test",
    "changeKey": "Change key",
    "advancedOptions": "Advanced options",
    "keyAutoSelected": "Key auto-selected for this tool",
    ...
    "unavailableHint": "Dimmed tools do not match this key. Select one to see why.",
    "configFields": "Connection fields",
    "expandConfig": "Expand full config",
    ...
    "limitReference": "TokenKey limit reference",
    "keyQuota": "Key quota",
    ...
    "clientDescriptions": {
      ...
      "qwen-code": "Qwen's open-source terminal coding agent.",
      ...
      "lobe-chat": "A self-hosted agent workspace.",
      "chatbox": "A cross-platform desktop AI client.",
      "workbuddy": "Tencent Cloud desktop work agent with tool calling and MCP.",
      "dify": "A production platform for agent workflows and LLM apps.",
...
const zh: LocaleOverlay = {
  ...
  "studio": {
    ...
    "chat": {
      ...
      "avatarUser": "我",
      "avatarAssistant": "AI",
      "limitsHint": "浏览器内最多保留 {turns} 轮对话；单次输出上限 {maxTok} tokens；单次对话请求超时 {timeoutSec} 秒。",
      "truncatedHint": "回复因达到 Max tokens 上限而被截断。请调大 Max tokens（最高 {maxTok}）后重新发送以获取完整内容。",
      "timedOut": "对话请求在 {timeoutSec} 秒后超时。请缩短提问、降低 Max tokens 后重试。",
      "lastUsage": "上次响应用量",
      ...
      "integrationsHint": "打开已准备连接参数的客户端；网页客户端不会在 URL 中携带密钥。",
      "integrationsAppHint": "需已安装对应客户端（通过自定义 URL Scheme 打开）。",
      "integrationsManualKeyHint": "仅携带网关地址打开提供商设置，请在客户端内粘贴 Key。",
      "integrationsManualKeyShort": "需粘贴 Key",
      "copyBaseUrl": "复制接入地址",
      "copyKey": "复制 API 密钥",
  ...
  "keys": {
    ...
    "qaBundle": {
      ...
      "export": "导出 ZIP",
      "exportContents": "包含会话、工具调用关联及已采集的请求证据。",
      "exporting": "生成中…",
      "failed": "QA 记录暂时不可用",
      "empty": "该归档窗口暂无 QA 记录",
      "platform": "平台",
  ...
  "quickstart": {
    ...
    "supportVerified": "推荐",
    "supportVerifiedDetail": "持续验证，与线上网关探测保持同步",
    "supportImport": "点一下就好",
    "supportImportDetail": "打开客户端并自动导入连接配置",
    "supportCompatible": "需手动粘贴",
    "supportCompatibleDetail": "标准协议兼容，请在客户端内粘贴密钥",
    "legendToggle": "了解徽章含义",
    "connectionWaiting": "等待首次请求",
    "connectionWaitingHint": "发送测试请求，确认 Key 与模型可用。",
    "probeAuthMs": "鉴权 {ms}ms",
    "probeModelMs": "模型 {ms}ms",
    "probeTotalMs": "合计 {ms}ms",
    "connectionConnected": "已连接",
    "connectionTesting": "正在验证连接…",
    "connectionFailed": "连接失败",
    "connectionBlocked": "请先完成接入配置",
    "sendTest": "发送测试请求",
    "retryTest": "重试",
    "changeKey": "更换 Key",
    "advancedOptions": "高级选项",
    "keyAutoSelected": "已为此工具自动选择 Key",
    "openAndImport": "打开并导入",
    ...
    "unavailableHint": "灰置工具与当前 Key 不兼容，选择后可查看具体原因。",
    "configFields": "连接参数",
    "expandConfig": "展开完整配置",
    "collapseConfig": "收起配置",
    ...
    "clientDescriptions": {
      ...
      "codex": "OpenAI 官方终端编码 Agent。",
      "qwen-code": "通义千问开源终端编码 Agent。",
      ...
      "lobe-chat": "可自部署的 Agent 工作空间。",
      "chatbox": "跨平台桌面 AI 客户端。",
      "workbuddy": "腾讯云桌面办公 Agent，支持工具调用与 MCP。",
      "dify": "面向生产的 Agent 工作流与 LLM 应用平台。",

export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      vertexGeminiHint: 'This is a native Gemini Vertex account for text chat. For Imagen / Veo media and Google Cloud trial credits, choose the Extension Engine platform and then the Vertex AI channel type.',
      ...
      vertexSaJsonUploadHint: 'After upload, drag-drop, or paste, project_id is extracted automatically; key material is only sent on create/rotate.',
      ...
      vertexSaJsonEditHint: 'Leave empty to keep the current Service Account JSON; paste a new JSON to rotate the key.',
      ...
      kiroPlatform: {
        ...
        tokenJsonCreateHint:
          'Paste the local kiro-auth-token.json export (accessToken, refreshToken, region, authMethod).',
        tokenJsonEditHint: 'Leave empty to keep current access/refresh tokens.',
        tokenJsonEditWriteOnceHint:
          'Paste only when rotating tokens; leave empty to keep the values stored on the server.',
        ...
        registrationJsonPlaceholder:
          'Paste ~/.aws/sso/cache/*.json with clientId and clientSecret (IdC only)',
        registrationJsonCreateHint:
          'Required for IdC auth. Paste the SSO cache registration file that contains clientId and clientSecret.',
        registrationJsonEditHint: 'Leave empty to keep the current IdC client secret.',
        registrationJsonEditWriteOnceHint:
          'Paste only when rotating IdC registration; leave empty to keep stored credentials.',
        ...
        tosAcknowledge:
          'I confirm I have read and accept the Kiro terms of service and the compliance risks of using this account.',
    ...
    ops: {
      ...
      sla: 'SLA (platform/provider faults)',
      ...
      tooltips: {
        ...
        errorTrend: 'Error counts over time (SLA = platform/provider faults; client faults in denominator only; upstream excludes 429/529).',
        errorDistribution: 'Error distribution by status code (SLA faults = platform/provider owner).',
        goroutines:
        ...
        sla: 'SLA: denominator is all terminal requests; numerator is platform/provider faults only. Client faults do not reduce SLA.',
        errors: 'Error stats: SLA count is platform/provider faults; client faults count in total errors but not SLA numerator.',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        antigravityUserAgentVersionHint: 'Leave empty to use ANTIGRAVITY_USER_AGENT_VERSION or the built-in default 2.2.1; when set, the admin setting takes precedence.',
        openaiCodexUserAgent: 'OpenAI Codex UA',
        openaiCodexUserAgentPlaceholder: 'codex-tui/0.142.5 (Mac OS 26.3.1; arm64) iTerm.app/3.6.11 (codex-tui; 0.142.5)',

export default {
  ...
  studio: {
    ...
    video: {
      ...
      copyLink: 'Copy link',
      copied: 'Copied',
      inlineCopyHint: 'Inline Veo clips cannot be shared as a browser link — download the file to watch locally.',
  ...
  admin: {
    ...
    accounts: {
      ...
      contactEmailPlaceholder: 'Account email (optional)',
      contactEmailHint: 'Used for CC userEmail backfill and ops identification. Auto-filled on OAuth success; you can also edit manually.',
      invalidContactEmail: 'Please enter a valid account email',
      allPlatforms: 'All Platforms',

export default {
  ...
  admin: {
    ...
    edgeAccounts: {
      ...
      summaryConfigLabel: 'Schedulable caps ({count} accounts)',
      summaryConcurrency: 'Concurrency {value}',
      summaryBaseRpm: 'Base RPM {base} (sticky {sticky})',
      summarySessions: 'Sessions {value}',

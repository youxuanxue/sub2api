export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      vertexNewapiMediaHint: 'For Imagen / Veo media models, use Extension Engine (newapi) + Vertex AI channel type with a non-empty model_mapping (e.g. imagen-4.0-fast-generate-001).',

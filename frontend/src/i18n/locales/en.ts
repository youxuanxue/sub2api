export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      noModelMappingHint: 'This account has no servable models declared (model mapping is empty), so there is nothing to test yet. Configure its models in account settings first.',

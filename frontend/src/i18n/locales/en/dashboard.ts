export default {
  dashboard: {
    ...
    avgGatewayLatency: "Today's Average Gateway Latency",
    gatewayAverageTime: 'Authentication and routing time',
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      antigravity: {
        description: 'Configure API access for the Google group. Select the configuration method based on your client.',
        claudeCode: 'Claude Code',
        geminiCli: 'Gemini CLI',
      ...
      gemini: {
        description: 'Add the following environment variables to your terminal profile or run directly in terminal to configure Google CLI access.',

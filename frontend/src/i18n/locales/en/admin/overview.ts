export default {
    ...
    groups: {
      ...
      members: {
        ...
        searchMembers: 'Search bound accounts...',
        ...
        searchCandidates: 'Search accounts to add...',
        addSelected: 'Add selected ({count})',
        alreadyBound: 'Bound',
        noCandidates: 'No eligible candidates',
        confirmRemove: 'Remove {count} account(s) from this group? Accounts themselves are not deleted.',
        confirmMixed: 'Anthropic and Antigravity are mixed in this group. Continue?',
        removeSuccess: 'Accounts removed',
        addSuccess: 'Accounts added',

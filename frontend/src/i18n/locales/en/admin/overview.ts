export default {
    ...
    groups: {
      ...
      members: {
        title: 'Member accounts — {name}',
        hint: 'Manage group↔account bindings (account_groups). Prefer universal keys across single-platform groups; do not mix platforms in a concrete group. Composite groups may hold multi-platform pools.',
        searchPlaceholder: 'Search accounts...',
        filterBoundYes: 'Bound',
        filterBoundNo: 'Unbound',
        colName: 'Name',
        ...
        prevPage: 'Previous',
        nextPage: 'Next',
        addHintSamePlatform: 'Only platform = {platform}. Toggle to bind/unbind.',
        addHintMixed: 'Same-platform accounts, or Antigravity with mixed_scheduling.',
        addHintComposite: 'Any concrete platform account (routed by model).',
        boundOn: 'Bound (click to unbind)',
        boundOff: 'Not bound (click to bind)',
        confirmUnbindOne: 'Unbind "{name}" from this group? The account itself is not deleted.',
        confirmMixed: 'Anthropic and Antigravity are mixed in this group. Continue?',
        removeSuccess: 'Account unbound',
        addSuccess: 'Account bound',
      ...
      videoPricing: {
        modelOverridesTitle: 'Model prices',
        modelOverridesDescription: 'Model prices override the default resolution prices.',
        title: 'Video Generation Pricing',
        description:
          'Configure Grok video generation prices in USD per second. Leave empty to use overlay default tier rates (see placeholders below).',

export default {
    accounts: {
      ...
      supportedProtocolsHint: 'Read-only protocol probe results. Re-probe here after fixing upstream configuration.',
      protocolCapabilityEmpty: 'No usable text protocol detected',
      protocolSharedAccounts: 'Shared by {count} accounts',
      protocolLastProbedAt: 'Last probed: {time}',
      protocolCapabilityConflict: 'Conflicting evidence was observed for this endpoint; protocol routing is disabled',
      protocolProbeAction: 'Re-probe protocols',
      protocolProbeRunning: 'Probing…',
      protocolProbeUpdated: 'Protocol probe completed and capabilities were updated',
      protocolProbeUnchanged: 'Protocol probe completed without a new conclusive capability result',
      protocolProbeInconclusive: 'Protocol probe was inconclusive; existing capabilities were preserved',
      protocolProbeNotApplicable: 'This account currently has no text protocol to probe',
      protocolProbeFailed: 'Protocol probe failed',
      ...
      duplicatePrompt: 'Duplicate “{name}”',
      duplicateCount: 'Number of copies',
      duplicateCountInvalid: 'Enter an integer from 1 to 100.',
      duplicateHint: 'Defaults to one copy. A trailing -number increments; other names start at -1. Copies are paused: reauthorize or check credentials before enabling. Shadow copies become independent accounts requiring authorization.',
      duplicateBatchSuccess: 'Created {count} paused account copies',
      oauthAuthorizationLink: 'OAuth authorization link',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'When multiple users share the same OAuth account, converge device/session identifiers to account-level stable values to reduce upstream-visible device and session count. Device-only is the default (one installation_id; API keys keep separate sessions). Off passes client identifiers through; device+session has been linked to quota-shrinkage reports.',
      ...
      gemini: {
        ...
        webSessionImportTitle: { initialize: 'Initialize Gemini Web Worker session', replace: 'Replace Gemini Web browser session' },
        ...
        webSessionImportSuccess: 'Replaced session with {count} cookies (runtime version {version}); scheduling unchanged',
        webSessionInitializeSuccess: 'Initialized session with {count} cookies (runtime version {version}); scheduling remains disabled. Enable it manually after review.',
        tier: {
          label: 'Account Tier',
        ...
        oauthType: {
          ...
          googleOneDesc: 'Deprecated Gemini CLI consumer channel. Keep only for existing accounts.',
          personalSubscriptionHint:
            'Use the Antigravity platform for personal Google AI Pro / Ultra. Gemini CLI consumer login stopped on 2026-06-18.',
          ...
          badges: {
            ...
            legacy: 'Deprecated',
            useAntigravity: 'Use Antigravity',
      ...
      usageWindow: {
        ...
        grokProbe: 'Query',
        grokProbeTooltip: 'Refresh billing usage and balance',

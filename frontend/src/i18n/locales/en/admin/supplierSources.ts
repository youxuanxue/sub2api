export default {
  supplierSources: {
    ...
    discoverNeedsSave: 'Configured model IDs were normalized from the upstream models API. Confirm and save. Probe-passed suggestions are added only via “Add suggestions to form”. Probe and sync stay disabled until save.',

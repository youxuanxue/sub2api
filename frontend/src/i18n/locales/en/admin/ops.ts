export default {
    ops: {
      ...
      systemLogs: {
        ...
        requestRetentionDaysHint: 'Keep request usage records for 1–90 days. Changes apply on the next scheduled cleanup.',
        retentionDaysInvalid: 'Keep operations logs for 1–3650 days and request logs for 1–90 days.',

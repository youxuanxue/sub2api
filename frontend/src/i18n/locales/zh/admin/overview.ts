export default {
    ...
    groups: {
      ...
      members: {
        ...
        searchMembers: '搜索已绑定账号...',
        removeSelected: '移出选中 ({count})',
        colName: '名称',
        colPlatform: '平台',
        colType: '类型',
        colStatus: '状态',
        ...
        addHintComposite: '可添加任意具体平台账号（按模型路由到对应 platform）',
        searchCandidates: '搜索可添加账号...',
        addSelected: '加入选中 ({count})',
        alreadyBound: '已绑定',
        noCandidates: '没有可添加的候选账号',
        confirmRemove: '确认从本分组移出 {count} 个账号？不会删除账号本身。',

export default {
    ...
    groups: {
      ...
      members: {
        title: '成员账号 — {name}',
        hint: '管理本分组与账号的绑定关系（account_groups）。多平台服务请用 universal key 选组，不要在单平台组混绑异平台账号；composite 组可挂多平台号池。',
        ...
        prevPage: '上一页',
        nextPage: '下一页',
        addHintSamePlatform: '只能绑定 platform = {platform} 的账号；用开关直接绑定/解绑。',
        addHintMixed: '可绑定同平台账号，或开启 mixed_scheduling 的 Antigravity 账号。',
        addHintComposite: '可绑定任意具体平台账号（按模型路由到对应 platform）。',
        boundOn: '已绑定（点击解绑）',
        boundOff: '未绑定（点击绑定）',
        confirmUnbindOne: '确认将账号「{name}」从本分组解绑？不会删除账号本身。',
        confirmMixed: '检测到 Anthropic 与 Antigravity 混合，确认继续？',
        removeSuccess: '已解绑账号',
        addSuccess: '已绑定账号',
        manage: '管理成员'
      },
      ...
      videoPricing: {
        modelOverridesTitle: '模型定价',
        modelOverridesDescription: '模型单价优先于默认分辨率单价。',
        title: '视频生成计费',
        description:
          '配置 Grok 视频生成的每秒单价（USD/秒），留空则使用 overlay 默认阶梯价（见下方占位提示）。',

...
export const TK_CLIENT_SUPPORT_META: Record<TkClientSupportTier, {
  ...
  detailKey: 'quickstart.supportVerifiedDetail' | 'quickstart.supportImportDetail' | 'quickstart.supportCompatibleDetail'
  legendClass: string
  badgeClass: string
}> = {
  verified: {
    ...
    detailKey: 'quickstart.supportVerifiedDetail',
  ...
  import: {
    ...
    detailKey: 'quickstart.supportImportDetail',
  ...
  compatible: {
    ...
    detailKey: 'quickstart.supportCompatibleDetail',

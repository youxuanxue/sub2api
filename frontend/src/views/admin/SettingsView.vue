    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.coldStart.title') }}
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.coldStart.description') }}
            </p>
          </div>
          <div class="space-y-6 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.coldStart.signupBonusEnabled') }}
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.coldStart.signupBonusEnabledHint') }}
                </p>
              </div>
              <label class="toggle">
                <input v-model="form.signup_bonus_enabled" type="checkbox" />
            ...
            <div>
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.coldStart.signupBonusBalance') }}
              </label>
              <div class="relative max-w-xs">
                <span
                  class="pointer-events-none absolute inset-y-0 left-3 flex items-center text-sm text-gray-500 dark:text-gray-400"
                  >$</span
                >
                <input
                  v-model.number="form.signup_bonus_balance"
                  type="number"
                  step="0.01"
                  min="0"
                  class="input pl-7"
                  placeholder="1.00"
                  :disabled="!form.signup_bonus_enabled"
                />
              </div>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.coldStart.signupBonusBalanceHint') }}
              </p>
            </div>
            ...
            <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.coldStart.autoGenerateDefaultToken') }}
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.coldStart.autoGenerateDefaultTokenHint') }}
                </p>
              </div>
              <label class="toggle">
                <input v-model="form.auto_generate_default_token" type="checkbox" />
                <span class="toggle-slider"></span>
              </label>
            </div>
            ...
            <div>
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.coldStart.autoGenerateDefaultTokenName') }}
              </label>
              <input
                v-model="form.auto_generate_default_token_name"
                type="text"
                maxlength="64"
                class="input max-w-xs font-mono text-sm"
                placeholder="trial"
                :disabled="!form.auto_generate_default_token"
              />
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.coldStart.autoGenerateDefaultTokenNameHint') }}
              </p>
            </div>
            ...
            <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.coldStart.pricingCatalogPublic') }}
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.coldStart.pricingCatalogPublicHint') }}
                </p>
              </div>
              <label class="toggle">
                <input v-model="form.pricing_catalog_public" type="checkbox" />
                <span class="toggle-slider"></span>
              </label>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="space-y-4 p-6">
            ...
            <template v-if="form.payment_enabled">
              <!-- Row 1: Product name -->
              <div class="grid grid-cols-3 gap-3">
                <div><label class="input-label">{{ t('admin.settings.payment.productNamePrefix') }}</label><input v-model="form.payment_product_name_prefix" type="text" class="input" placeholder="TokenKey" /></div>

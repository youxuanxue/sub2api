<template>
    ...
    >
      <form id="key-form" @submit.prevent="handleSubmit" class="space-y-5">
        ...
        <template v-if="!formData.universal">
...
<script setup lang="ts">
	import { ref, reactive, computed, watch, onMounted, onActivated, onDeactivated, onUnmounted, type ComponentPublicInstance } from 'vue'

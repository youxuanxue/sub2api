              ...
              <div class="card p-5">
                ...
                <div class="mb-3 flex flex-wrap items-center gap-2">
                  <span :class="['rounded-md border px-2 py-0.5 text-xs font-medium', planBadgeClass]">
                    {{ getPublicPlatformLabel(selectedPlan.group_platform) }}
                  </span>
              ...
              <div v-if="activeSubscriptions.length > 0">
                ...
                <div class="space-y-2">
                  <div v-for="sub in activeSubscriptions" :key="sub.id"
                    ...
                    <div :class="['h-6 w-1 shrink-0 rounded-full', platformAccentBarClass(getPublicPlatformStyleKey(sub.group?.platform))]" />
                    <div class="min-w-0 flex-1">
                      <div class="flex items-center gap-1.5">
                        ...
                        <span :class="['shrink-0 rounded-full px-1.5 py-0.5 text-[9px] font-medium', platformBadgeLightClass(getPublicPlatformStyleKey(sub.group?.platform))]">{{ getPublicPlatformLabel(sub.group?.platform) }}</span>
                      </div>
...
const planBadgeClass = computed(() => platformBadgeClass(getPublicPlatformStyleKey(selectedPlan.value?.group_platform)))
const planTextClass = computed(() => platformTextClass(getPublicPlatformStyleKey(selectedPlan.value?.group_platform)))

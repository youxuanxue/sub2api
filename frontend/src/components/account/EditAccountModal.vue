...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (props.account.type === 'apikey') {
      ...
      let newCredentials: Record<string, unknown> = { ...currentCredentials }
      ...
      if (isNewAPI) {
        ...
        const submittedBaseUrl = editBaseUrl.value.trim() || (props.account.platform === PLATFORM_GROK ? '' : defaultBaseUrl.value)

...
type ChannelMonitor struct {
	...
	Kind channelmonitor.Kind `json:"kind,omitempty"`
	// SeedSource holds the value of the "seed_source" field.
...
func (*ChannelMonitor) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case channelmonitor.FieldName, channelmonitor.FieldProvider, channelmonitor.FieldAPIMode, channelmonitor.FieldEndpoint, channelmonitor.FieldAPIKeyEncrypted, channelmonitor.FieldPrimaryModel, channelmonitor.FieldGroupName, channelmonitor.FieldBodyOverrideMode, channelmonitor.FieldKind, channelmonitor.FieldSeedSource:
	...
	for i := range columns {
		...
		case channelmonitor.FieldKind:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.Kind = channelmonitor.Kind(value.String)
			}
		case channelmonitor.FieldSeedSource:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field seed_source", values[i])
			} else if value.Valid {
				_m.SeedSource = value.String
			}
		default:
...
func (_m *ChannelMonitor) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("seed_source=")
	builder.WriteString(_m.SeedSource)
	builder.WriteByte(')')

...
type Group struct {
	...
	ModelRouting domain.GroupModelRouting `json:"model_routing,omitempty"`
	// 是否启用模型路由配置
	...
	// Legacy model listing filter; does not restrict request admission
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldStickyRoutingMode, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:

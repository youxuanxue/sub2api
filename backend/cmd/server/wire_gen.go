...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	protocolRoutingSSOTReady := service.ProvideProtocolRoutingSSOTReady(accountRepository, router)

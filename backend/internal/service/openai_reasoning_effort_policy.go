...
func NormalizeReasoningEffortMappings(platform string, raw []domain.ReasoningEffortMapping) ([]domain.ReasoningEffortMapping, error) {
	...
	normalized := make([]domain.ReasoningEffortMapping, 0, len(raw))
...
func mapReasoningEffort(raw string, mappings []domain.ReasoningEffortMapping) (string, bool) {
...
func sanitizeGroupReasoningEffortPolicy(group *Group) {
	...
	if mappingsErr != nil {
		mappings = []domain.ReasoningEffortMapping{}
	}
...
// stay in control.
func ApplyOpenAIReasoningEffortPolicy(body []byte, maxEffort string, mappings []domain.ReasoningEffortMapping) ([]byte, bool) {

...
type AdminService interface {
	...
	// Account management
	ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search string, groupID int64, privacyMode string, sortBy, sortOrder string, channelType int) ([]Account, int64, error)
	...
	SaveCursorAccount(ctx context.Context, create *CreateAccountInput, update *UpdateAccountInput, accountID int64) (*Account, error)

...
func isWholeAccountRuntimeBlockReason(reason string) bool {
	...
	case newAPIMonthlyModelCooldownReason, "402_cloudwise_model_balance", "429_codex_metered", "429_model_class", "429_mirror_class_downstream_empty", "429_openai_mirror_downstream_empty":
		return false
	default:
		return true
	}

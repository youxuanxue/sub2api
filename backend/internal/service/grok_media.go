...
// SelectMediaVideoRequestAccount only admits the already authenticated task owner.
// Generic sticky fallback can query another account and overwrite the ownership key.

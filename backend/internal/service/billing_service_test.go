...
func TestCalculateCost_DoubaoEmbeddingVisionDifferentialInput(t *testing.T) {
	...
	require.InDelta(t, float64(28)*0.252e-6, cost.ImageInputCost, 1e-15)
	...
	require.NoError(t, err)
	require.Zero(t, costWeird.InputCost, "text tokens clamped to 0 when image tokens exceed input tokens")

...
func (m *mockAccountRepoForGemini) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, channelType int) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
func (m *mockAccountRepoForGemini) ListAllWithFilters(ctx context.Context, platform, accountType, status, search string, groupID int64, privacyMode string, channelType int) ([]Account, error) {
	return nil, nil
}
...
func (m *mockAccountRepoForGemini) ClearObservedUsageWindows(ctx context.Context, id int64) error {
	return nil
}

...
func TestGrokChatResponsesRuntimeEligibility(t *testing.T) {
	t.Parallel()
	require.True(t, grokChatResponsesRuntimeEligible(grokDefaultResponsesModel, "isolated-id"))
	...
	require.False(t, grokChatResponsesRuntimeEligible(grokDefaultResponsesModel, ""))
}

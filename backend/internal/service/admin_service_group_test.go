...
func TestAdminService_CreateGroup_PreservesFastPolicyAcrossBillingPlatforms(t *testing.T) {
	for _, tt := range []struct {
		...
		{name: "anthropic", platform: PlatformAnthropic, want: true},
	} {
		t.Run(tt.name, func(t *testing.T) {
			repo := &groupRepoStubForAdmin{}
			svc := &adminServiceImpl{groupRepo: repo}
...
func TestAdminService_UpdateGroup_PreservesFastPolicyWhenBillingPlatformChanges(t *testing.T) {
	existingGroup := &Group{

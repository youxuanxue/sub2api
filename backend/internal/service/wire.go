...
func ProvideCursorOAuthClient(rdb *redis.Client, upstream HTTPUpstream) *cursor.Client {
	return cursor.NewClient(rdb, func(req *http.Request) (*http.Response, error) {
...
func ProvideRateLimitService(
	...
	antigravityValidationCounterCache AntigravityValidationCounterCache,
	internal500CounterCache Internal500CounterCache,
	escalationSlotCache EscalationSlotCache,
	settingService *SettingService,
	...
	svc.SetAntigravityValidationCounterCache(antigravityValidationCounterCache)
	svc.SetInternal500CounterCache(internal500CounterCache)
	svc.SetEscalationSlotCache(escalationSlotCache)
...
var ProviderSet = wire.NewSet(
	...
	NewAdminService,
	ProvideSupplierManagedAccountCommands,
	NewProtocolRouter,
	...
	wire.Bind(new(SupplierSourceProbe), new(*AccountTestService)),
	NewSupplierCredentialFingerprinter,
	NewSupplierSourceAccountStore,
	NewSupplierSourceService,

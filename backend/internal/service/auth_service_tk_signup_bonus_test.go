...
// US-028 unit coverage: signup-bonus injection across the active register paths.
//
...
func TestUS028_RegisterEmailPath_AppliesBonus_DefaultSetting(t *testing.T) {
...
func TestUS028_RegisterEmailPath_BonusDisabled_NoIncrement(t *testing.T) {
...
func TestUS028_RegisterEmailPath_BonusZero_NoIncrement(t *testing.T) {
...
func TestUS028_RegisterEmailPath_AdminChangedBonus_TakesEffectImmediately(t *testing.T) {
...
func TestUS028_RegisterEmailPath_NegativeBonus_ClampedToZero(t *testing.T) {
...
func TestUS028_RegisterEmailPath_NoSettingService_NoBonus(t *testing.T) {
...
func TestUS028_LogSignupBonusCredited_ZeroIsSilent(t *testing.T) {

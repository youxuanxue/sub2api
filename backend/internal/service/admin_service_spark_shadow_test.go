...
func (s *sparkShadowRepoStub) ListWithFilters(_ context.Context, _ pagination.PaginationParams, _, _, _, _ string, _ int64, _ string, _ int) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}

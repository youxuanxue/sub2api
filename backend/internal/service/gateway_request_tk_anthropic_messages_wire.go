...
//  3. tkStripTokenseaFableContextManagement (tokensea+fable CM reject)
//
// Callers that already applied (1) or (3) may call this anyway — all three
// steps are idempotent on a clean body.
...
// when the latest assistant turn is tool-coupled / prefill-preserved.

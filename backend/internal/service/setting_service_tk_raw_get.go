...
// keys (currently the scoped account model-mapping replacement) that are not
// fields on SystemSettings. Returns ok=false when the key is absent, errored, or
// set to an empty string (callers treat empty as "use the compile default").
//

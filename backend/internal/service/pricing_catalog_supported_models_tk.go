...
// The two maps below are regenerated by
// ops/pricing/refresh-servable-allowlist.py from a live prod probe. The
...
// blocks will be overwritten on the next refresh. Last probe: 2026-06-05.

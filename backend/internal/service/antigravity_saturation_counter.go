...
// scope and rolling window; saturation is a preference, never a cooldown.
...
type AntigravitySaturationReader interface {
	GetSaturationBatch(context.Context, []AntigravitySaturationScope, int) (map[AntigravitySaturationScope]int64, error)
}

...
func TestCalculateVideoCost_PerSecondFromLiteLLM(t *testing.T) {
	...
	// 8s × $0.40 = $3.20
	cost := svc.CalculateVideoCost("veo-3.1-generate-preview", VideoBillingResolution720P, 1, 8, nil, 1.0, nil)
	...
	cost = svc.CalculateVideoCost("veo-3.1-generate-preview", VideoBillingResolution720P, 1, 4, nil, 2.0, nil)
...
func TestCalculateVideoCost_UnpricedModelIsZeroNotBlocking(t *testing.T) {
	...
	cost := svc.CalculateVideoCost("veo-unknown-model", VideoBillingResolution720P, 1, 8, nil, 1.0, nil)
...
func TestCalculateVideoCost_NonPositiveSecondsClampedToOne(t *testing.T) {
	...
	cost := svc.CalculateVideoCost("veo-3.1-generate-preview", VideoBillingResolution720P, 1, 0, nil, 1.0, nil)

...
var routeRegistry = []routeEntry{
	...
	{inbound: ProtocolMessages, target: ProtocolGeminiGenerateContent, kind: RouteConversion, adapterID: AdapterMessagesToGemini, transport: TransportHTTP, model: permitsGeminiModel, preserves: preservesMessagesToGemini, endpoint: resolveEndpoint},
	...
	{inbound: ProtocolChatCompletions, target: ProtocolGeminiGenerateContent, kind: RouteConversion, adapterID: AdapterChatToGemini, transport: TransportHTTP, model: permitsGeminiModel, preserves: preservesChatToGemini, endpoint: resolveEndpoint},

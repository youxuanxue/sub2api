...
func BenchmarkSessionExport(b *testing.B) {
	...
	for _, c := range []struct {
		...
		{"single_turn", 300, 1, false}, {"ten_turn", 30, 10, false}, {"fifty_turn", 6, 50, false}, {"ten_turn_sse", 30, 10, true}, {"large_single", 1200, 1, false}, {"large_ten", 120, 10, false}, {"spill_single", 6000, 1, false},
	} {

...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, eitherAuth, auditLog, stepUpAuth, apiKeyService, userService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterUserRoutes(v1, h, jwtAuth, eitherAuth, auditLog, settingService)

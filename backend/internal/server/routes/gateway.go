...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gatewayRoutes.Register(http.MethodPost, "/audio/transcriptions", SyncInference, tkOpenAICompatAudioTranscriptionHandler(h))
	...
	rootRoutes.Register(http.MethodPost, "/api/v3/contents/generations/tasks", SyncInference, bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodGet, "/api/v3/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodDelete, "/api/v3/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodPost, "/v3/contents/generations/tasks", SyncInference, bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodGet, "/v3/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodDelete, "/v3/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodPost, "/v1/contents/generations/tasks", SyncInference, bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodGet, "/v1/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodDelete, "/v1/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodPost, "/contents/generations/tasks", SyncInference, bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodGet, "/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)
	rootRoutes.Register(http.MethodDelete, "/contents/generations/tasks/:task_id", Excluded("status"), bodyLimit, clientRequestID, trajectoryID, qaCapture, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, requireGroupAnthropic, h.OpenAIGateway.SeedanceTasks)

...
func TestEveryGatewayPOSTRouteIsClassifiedForPromptAuditCoverage(t *testing.T) {
	...
	audited := map[string][]string{
		"/api/v3/contents/generations/tasks": {"grok_media.go"},
		"/v3/contents/generations/tasks":     {"grok_media.go"},
		...
		"/images":                            {"openai_gateway_embeddings_images.go", "grok_media.go", "gateway_handler_chat_completions.go"},
		...
		"/audio/speech":                      {"openai_gateway_audio_speech_tk.go"},
		"/audio/transcriptions":              {"openai_gateway_audio_speech_tk.go"},
		"/videos":                            {"grok_media.go", "openai_gateway_tk_video.go"},
		"/videos/generations":                {"grok_media.go"},
		"/videos/edits":                      {"grok_media.go"},
		"/videos/extensions":                 {"grok_media.go"},
		"/video/generations":                 {"openai_gateway_tk_video.go"},
	...
	excluded := map[string]string{
		...
		"/images/presign":            "presigned URL re-mint for offloaded image bytes; no model prompt",
	}

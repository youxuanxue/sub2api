	...
	}{
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"run_mode": "standard",
					"traj_export_platforms": ["anthropic", "kiro", "gemini", "antigravity", "openai", "newapi", "grok", "kimi", "zhipu", "deepseek"]
				}
			}`,
		},
		{
		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":null},"antigravity":{"daily":null,"weekly":null,"monthly":null},"deepseek":{"daily":null,"weekly":null,"monthly":null},"gemini":{"daily":null,"weekly":null,"monthly":null},"grok":{"daily":null,"weekly":null,"monthly":null},"kimi":{"daily":null,"weekly":null,"monthly":null},"kiro":{"daily":null,"weekly":null,"monthly":null},"newapi":{"daily":null,"weekly":null,"monthly":null},"openai":{"daily":null,"weekly":null,"monthly":null},"zhipu":{"daily":null,"weekly":null,"monthly":null}},
					...
					"fallback_model_antigravity": "gemini-3-flash",
...
func (r *stubUserRepo) BatchUpdateLimits(ctx context.Context, userIDs []int64, concurrency *int, rpm *int) (int, error) {
	return 0, errors.New("not implemented")
}

...
func TestGatewayHandlerMessages_NonKiroRequestDoesNotConsumeKiroRecovery(t *testing.T) {
	...
	account := &service.Account{
		...
		Credentials: map[string]any{"access_token": "at", "project_id": "project-test", "intercept_warmup_requests": true, "model_mapping": map[string]any{"claude-sonnet-4-6": "claude-sonnet-4-6"}},

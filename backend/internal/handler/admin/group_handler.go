...
type CreateGroupRequest struct {
	...
	Description               string                        `json:"description"`
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity newapi kiro grok kimi zhipu deepseek minimax opencode_go composite"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		StickyRoutingMode:                      req.StickyRoutingMode,
		ModelsListConfig:                       req.ModelsListConfig,
		ModelAllowlist:                         req.ModelAllowlist,
		CodexModelsManifestConfig:              req.CodexModelsManifestConfig,
		RPMLimit:                               req.RPMLimit,
		MessagesCompactionEnabled:              req.MessagesCompactionEnabled,
		MessagesCompactionInputTokensThreshold: req.MessagesCompactionInputTokensThreshold,

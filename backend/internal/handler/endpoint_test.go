...
func TestNormalizeInboundEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"/v1/video/generations/vt_123", EndpointVideoGenerations},
		{"/openai/v1/video/generations/vt_123/content", EndpointVideoGenerations},
...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"newapi video generation", EndpointVideoGenerations, "/v1/video/generations", service.PlatformNewAPI, EndpointVideoGenerations},
		{"newapi video status", EndpointVideoGenerations, "/v1/video/generations/vt_123", service.PlatformNewAPI, EndpointVideoGenerations},

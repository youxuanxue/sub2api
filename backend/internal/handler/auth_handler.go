...
func (h *AuthHandler) respondWithTokenPair(c *gin.Context, user *service.User) {
	respondWithTokenPair(c, h.authService, user, func(refreshToken string) {
		h.setTkRefreshSessionCookie(c, refreshToken)
	})
}

func respondWithTokenPair(c *gin.Context, authService *service.AuthService, user *service.User, setRefreshCookie func(refreshToken string)) {
	...
	if setRefreshCookie != nil {
		setRefreshCookie(tokenPair.RefreshToken)
	}
	response.Success(c, AuthResponse{

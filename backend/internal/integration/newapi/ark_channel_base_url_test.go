...
func TestNormalizeArkChannelBaseURL(t *testing.T) {
	...
	tests := []struct {
		...
		{newapiconstant.ChannelTypeVolcEngine, "https://ark.cn-beijing.volces.com/api/plan/v3", VolcEngineAgentPlanBaseKey},
		{newapiconstant.ChannelTypeVolcEngine, "https://ark.cn-beijing.volces.com/api/plan/v3/", VolcEngineAgentPlanBaseKey},
		{newapiconstant.ChannelTypeVolcEngine, "https://ark.cn-beijing.volces.com/api/plan/v3/chat/completions", VolcEngineAgentPlanBaseKey},
		{newapiconstant.ChannelTypeVolcEngine, VolcEngineAgentPlanBaseKey, VolcEngineAgentPlanBaseKey},

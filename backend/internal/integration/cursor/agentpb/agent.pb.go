...
type InteractionUpdate struct {
	...
	TokenDelta        *TokenDeltaUpdate      `protobuf:"bytes,8,opt,name=token_delta,json=tokenDelta,proto3" json:"token_delta,omitempty"`
...
const file_agent_proto_rawDesc = "" +
	...
	"\vtoken_delta\x18\b \x01(\v2\x1a.agent.v1.TokenDeltaUpdateR\n" +
	"tokenDelta\x128\n" +
	"\n" +
	...
	"\x06tokens\x18\x01 \x01(\x05R\x06tokens\"\xdc\x02\n" +

...
type AgentClientMessage struct {
	...
	// Fail one exec in-band (oh-my-pi / Cursor CLI): throw then stream_close so the
	// server surfaces the error to the model instead of blocking on a reply.
	ExecClientControlMessage *ExecClientControlMessage `protobuf:"bytes,5,opt,name=exec_client_control_message,json=execClientControlMessage,proto3" json:"exec_client_control_message,omitempty"`
...
type ExecClientControlMessage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StreamClose   *ExecClientStreamClose `protobuf:"bytes,1,opt,name=stream_close,json=streamClose,proto3" json:"stream_close,omitempty"`
	Throw         *ExecClientThrow       `protobuf:"bytes,2,opt,name=throw,proto3" json:"throw,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_agent_proto_rawDesc = "" +
	"\n" +
	"\vagent.proto\x12\bagent.v1\x1a\x1cgoogle/protobuf/struct.proto\"\x96\x03\n" +
	...
	"\x13conversation_action\x18\x04 \x01(\v2\x1c.agent.v1.ConversationActionR\x12conversationAction\x12a\n" +
	"\x1bexec_client_control_message\x18\x05 \x01(\v2\".agent.v1.ExecClientControlMessageR\x18execClientControlMessage\"\xcc\x03\n" +
	...
	"\n" +
	"error_code\x18\x04 \x01(\tH\x01R\terrorCode\x88\x01\x01B\x0e\n" +
	"\f_stack_traceB\r\n" +
	"\v_error_code\"\x8f\x01\n" +
	"\x18ExecClientControlMessage\x12B\n" +
	"\fstream_close\x18\x01 \x01(\v2\x1f.agent.v1.ExecClientStreamCloseR\vstreamClose\x12/\n" +
	"\x05throw\x18\x02 \x01(\v2\x19.agent.v1.ExecClientThrowR\x05throw\"Q\n" +

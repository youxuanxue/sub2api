...
func TestDefaultModelMappingIncludesGrokAliases(t *testing.T) {
	...
	require.Equal(t, DefaultTextModel, mapping[DefaultTextModel])
	require.Equal(t, DefaultTextModel, mapping["grok-4.6"])
	require.Equal(t, DefaultTextModel, mapping["grok-4.6-latest"])

...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 64, "arg-type table must include session_id and codex_installation_id")
	...
	// native_compaction_v2 and created_at follow codex_installation_id and session_id.

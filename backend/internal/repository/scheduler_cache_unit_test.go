...
func TestBuildSchedulerMetadataAccount_KeepsRPMFieldsForRPMGate(t *testing.T) {
	...
	t.Run("tiered", func(t *testing.T) {
		...
		require.Equal(t, service.WindowUtilNotSchedulable, account.CheckRPMSchedulability(11),
		...
		require.Equal(t, service.WindowUtilNotSchedulable, restored.CheckRPMSchedulability(11),
	...
	t.Run("sticky_exempt", func(t *testing.T) {
		...
		require.Equal(t, service.WindowUtilStickyOnly, account.CheckRPMSchedulability(100),
			"前置条件：粘性豁免策略没有红区")
		...
		require.Equal(t, service.WindowUtilStickyOnly, restored.CheckRPMSchedulability(100),

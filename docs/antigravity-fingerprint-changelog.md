...
| 2026-06-29 | **2.2.1** | **align (release-watch)** | `DefaultUserAgentVersion` 2.0.11 → 2.2.1 | Homebrew cask antigravity 2.2.1 per client-release-watch #1060; version-only bump (HTTP UA format unchanged). Prefer admin hot-push for future IDE auto-updates. |

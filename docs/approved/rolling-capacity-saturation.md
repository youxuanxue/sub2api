...
status: approved
approved_by: "user (conversation approval of threshold 5, 2026-09-21; revised design, 2026-09-17)"
...
rolling 10-minute window. A candidate becomes saturated after 5 capacity
...
- The 5-event threshold and continuous penalty apply across existing
  saturation counters.

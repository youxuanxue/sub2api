...
Phase 1 / uk1 sample:
  ...
  抽出 ops/stage0/verify_ghcr_manifest.sh / stage0_deploy_via_ssm.sh / stage0_external_health.sh，prod/test 和 Edge workflow 都调用同一套脚本。
...
deploy-stage0 与 deploy-edge-stage0 必须共享 ops/stage0/deploy_via_ssm.sh。

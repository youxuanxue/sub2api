...
- `POST /api/v1/admin/subscriptions/bulk-action` from `backend/internal/server/routes/admin.go`
...
- `DELETE /api/v1/edge/gemini-web/accounts/:id/lease` from `backend/internal/server/routes/edge_tk_routes.go`
- `POST /api/v1/edge/gemini-web/accounts/:id/lease` from `backend/internal/server/routes/edge_tk_routes.go`
- `PUT /api/v1/edge/gemini-web/accounts/:id/runtime` from `backend/internal/server/routes/edge_tk_routes.go`
- `GET /api/v1/edge/gemini-web/accounts/:id/session` from `backend/internal/server/routes/edge_tk_routes.go`
- `GET /api/v1/edge/gemini-web/warm-accounts` from `backend/internal/server/routes/edge_tk_routes.go`
...
- `GET /custom-voices/:voice_id` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
- `PATCH /custom-voices/:voice_id` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
- `GET /custom-voices/:voice_id/audio` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
...
- `POST /openrouter/v1/images` from `backend/internal/server/routes/gateway_tk_openrouter_routes.go`
- `GET /openrouter/v1/models` from `backend/internal/server/routes/gateway_tk_openrouter_routes.go`
- `POST /openrouter/v1/videos` from `backend/internal/server/routes/gateway_tk_openrouter_routes.go`
- `GET /openrouter/v1/videos/:id` from `backend/internal/server/routes/gateway_tk_openrouter_routes.go`
- `GET /realtime` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
...
- `POST /stt` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
...
- `GET /v1/custom-voices/:voice_id` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
- `PATCH /v1/custom-voices/:voice_id` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
- `GET /v1/custom-voices/:voice_id/audio` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
...
- `GET /v1/realtime` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
...
- `POST /v1/web_search` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
- `POST /v1/x_search` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
...
- `POST /web_search` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`
- `POST /x_search` from `backend/internal/server/routes/gateway_tk_grok_voice_routes.go`

...
- `GET /v1/videos/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/:request_id/content` from `backend/internal/server/routes/gateway.go`
- `POST /v1/videos/edits` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/edits/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/edits/:request_id/content` from `backend/internal/server/routes/gateway.go`
- `POST /v1/videos/extensions` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/extensions/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/extensions/:request_id/content` from `backend/internal/server/routes/gateway.go`
- `POST /v1/videos/generations` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/generations/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /v1/videos/generations/:request_id/content` from `backend/internal/server/routes/gateway.go`
...
- `GET /videos/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /videos/:request_id/content` from `backend/internal/server/routes/gateway.go`
- `POST /videos/edits` from `backend/internal/server/routes/gateway.go`
- `GET /videos/edits/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /videos/edits/:request_id/content` from `backend/internal/server/routes/gateway.go`
- `POST /videos/extensions` from `backend/internal/server/routes/gateway.go`
- `GET /videos/extensions/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /videos/extensions/:request_id/content` from `backend/internal/server/routes/gateway.go`
- `POST /videos/generations` from `backend/internal/server/routes/gateway.go`
- `GET /videos/generations/:request_id` from `backend/internal/server/routes/gateway.go`
- `GET /videos/generations/:request_id/content` from `backend/internal/server/routes/gateway.go`

...
| 2.1.205 | 2026-07-09 | pure UA | 2.1.202 → 2.1.205. TLS ja3 unchanged; stainless **0.94.0** unchanged (TLS capture via `capture-cc-fingerprint.sh`; HTTP mitm skipped — Claude Desktop not running). Bundle: `.tls_list/20260709T061548Z-cc-capture.bundle.json`. Closes client-release-watch #1280 / #1268. |

...
- 自动测试：`AntigravityRecoveryLinks.spec.ts`、`useAntigravityOAuth.spec.ts`、`TestAntigravityAuthorizationLinkMatchesSession`、`ReAuthAccountModal.antigravity.spec.ts`。

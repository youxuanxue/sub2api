...
| Runtime code anchor | `v1.8.195` release (`backend/cmd/server/VERSION`); last live deploy `v1.8.194`. Deployed successfully on 2026-08-27 by Stage0 run `33040897798`. The 2026-07-05 focused Anthropic closeout also includes the live config remediation that set edge default Anthropic group `id=1` to `claude_code_only=false` on `us3/us4/us5/us6`. |

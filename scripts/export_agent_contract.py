...
RETIRED_HTTP_ROUTES = (
    ...
    },
    {
        ...
        "replacement": "/api/v1/users/me/qa/bundle-exports/:job_id",
    },
    {
        "method": "POST",
    ...
    {
        "method": "GET",
        "path": "/api/v1/users/me/qa/traj/export/jobs/:job_id",
        "source": "backend/internal/server/routes/user_tk_routes.go",
        "source_literal": "/users/me/qa/traj/export/jobs/:job_id",
        "replacement": "/api/v1/users/me/qa/bundles/:job_id",
    },
    {
        "method": "GET",
        "path": "/api/v1/users/me/qa/traj/exports/*key",
        "source": "backend/internal/server/routes/user_tk_routes.go",
        "source_literal": "/users/me/qa/traj/exports/*key",
        "replacement": "/api/v1/users/me/qa/bundle-exports/:job_id",
    },
)

...
ALIGNMENT_KEYS: list[tuple[str, str | None, str, str]] = [
    ...
    ("chinaExport.siteTitle", "chinaExport", "siteTitle", "chinaExportSiteTitle"),
    ("chinaExport.metaDescription", "chinaExport", "metaDescription", "chinaExportMetaDescription"),
    ("chinaExport.ogDescription", "chinaExport", "ogDescription", "chinaExportOGDescription"),
    ("chinaExport.twitterDescription", "chinaExport", "twitterDescription", "chinaExportTwitterDescription"),
    ("chinaExport.canonicalUrl", "chinaExport", "canonicalUrl", "chinaExportCanonicalURL"),
    ("chinaExport.ogImageUrl", "chinaExport", "ogImageUrl", "chinaExportOGImageURL"),

#!/usr/bin/env python3
"""
check-brand.py — verify outward TokenKey brand surfaces stay intact.

Reads `scripts/sentinels/brand.json` and for each entry verifies the file exists
...
REGISTRY_PATH = REPO_ROOT / "scripts" / "sentinels" / "brand.json"
...
def main() -> int:
    ...
    if args.json:
        ...
        if fail_count == 0:
            ...
            print(
                "  Source of truth: scripts/sentinels/brand.json",
                file=sys.stderr,
            )
            print(

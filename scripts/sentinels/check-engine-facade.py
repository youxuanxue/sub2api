#!/usr/bin/env python3
"""
check-engine-facade.py — ensure key dispatch paths stay routed through Engine facade truth.

Source of truth lives in `scripts/sentinels/engine-facade.json`:
...
REGISTRY_PATH = REPO_ROOT / "scripts" / "sentinels" / "engine-facade.json"

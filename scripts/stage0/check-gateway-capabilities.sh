...
cd "$repo_root"
cp ops/stage0/generated/gateway-catalog.json "$output_dir/catalog.json"
previous_args=()
...
python3 ops/stage0/post_release_replay_check.py plan --catalog "$output_dir/catalog.json" \
